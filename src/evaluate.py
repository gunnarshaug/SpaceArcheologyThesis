from utils import write_results_summary_csv, compute_accuracy, apply_nms
import torchvision
...
def evaluate_model(model, loader):
    ...
    write_results_summary_csv(counter, true_positives, false_positives, false_negatives, 0.005, 120, "Slope_RGB_Fixed_Val_Add_Augm_120_Epochs_Summary_1")
